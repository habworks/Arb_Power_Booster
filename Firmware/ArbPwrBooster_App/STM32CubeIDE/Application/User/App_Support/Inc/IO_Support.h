...
#define CH1_FAN_ENABLE()        HAL_GPIO_WritePin(EN_FAN_1_GPIO_Port, EN_FAN_1_Pin, GPIO_PIN_SET)
#define CH1_FAN_DISABLE()       HAL_GPIO_WritePin(EN_FAN_1_GPIO_Port, EN_FAN_1_Pin, GPIO_PIN_RESET)
#define CH1_FAN_TOGGLE()        HAL_GPIO_TogglePin(EN_FAN_1_GPIO_Port, EN_FAN_1_Pin)
#define CH1_FAN_STATUS()        HAL_GPIO_ReadPin(EN_FAN_1_GPIO_Port, EN_FAN_1_Pin)

#define CH2_FAN_ENABLE()        HAL_GPIO_WritePin(EN_FAN_2_GPIO_Port, EN_FAN_2_Pin, GPIO_PIN_SET)
#define CH2_FAN_DISABLE()       HAL_GPIO_WritePin(EN_FAN_2_GPIO_Port, EN_FAN_2_Pin, GPIO_PIN_RESET)
#define CH2_FAN_TOGGLE()        HAL_GPIO_TogglePin(EN_FAN_2_GPIO_Port, EN_FAN_2_Pin)
#define CH2_FAN_STATUS()        HAL_GPIO_ReadPin(EN_FAN_2_GPIO_Port, EN_FAN_2_Pin)
