    ...
    flexButtonCallback(this, &Screen_MainViewBase::flexButtonCallbackHandler)
{
    ...
    textArea_CH2_Set.setColor(touchgfx::Color::getColorFromRGB(255, 51, 255));
    ...
    textArea_CH2_InputZ.setColor(touchgfx::Color::getColorFromRGB(255, 51, 255));
    ...
    textArea_CH2_Vrms.setXY(262, 175);
    textArea_CH2_Vrms.setColor(touchgfx::Color::getColorFromRGB(255, 51, 255));
    textArea_CH2_Vrms.setLinespacing(0);
    Unicode::snprintf(textArea_CH2_VrmsBuffer, TEXTAREA_CH2_VRMS_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_R38G).getText());
    textArea_CH2_Vrms.setWildcard(textArea_CH2_VrmsBuffer);
    textArea_CH2_Vrms.resizeToCurrentText();
    textArea_CH2_Vrms.setTypedText(touchgfx::TypedText(T___SINGLEUSE_5HPX));
    add(textArea_CH2_Vrms);

    textArea_CH2_CurrentSet.setXY(262, 150);
    textArea_CH2_CurrentSet.setColor(touchgfx::Color::getColorFromRGB(255, 51, 255));
    ...
    textArea_CH2_Amin.setColor(touchgfx::Color::getColorFromRGB(255, 51, 255));
    ...
    textArea_CH2_UnitsMax.setColor(touchgfx::Color::getColorFromRGB(255, 51, 255));
    ...
    textArea_CH2_Amax.setXY(262, 76);
    textArea_CH2_Amax.setColor(touchgfx::Color::getColorFromRGB(255, 51, 255));
    textArea_CH2_Amax.setLinespacing(0);
    Unicode::snprintf(textArea_CH2_AmaxBuffer, TEXTAREA_CH2_AMAX_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_1XNY).getText());
    textArea_CH2_Amax.setWildcard(textArea_CH2_AmaxBuffer);
    textArea_CH2_Amax.resizeToCurrentText();
    textArea_CH2_Amax.setTypedText(touchgfx::TypedText(T___SINGLEUSE_LA7G));
    add(textArea_CH2_Amax);

    textArea_CH2_UnitsRMS.setXY(365, 46);
    textArea_CH2_UnitsRMS.setColor(touchgfx::Color::getColorFromRGB(255, 51, 255));
    ...
    textArea_CH2_Arms.setColor(touchgfx::Color::getColorFromRGB(255, 51, 255));
    ...
    textArea_CH2.setColor(touchgfx::Color::getColorFromRGB(255, 51, 255));
    ...
    textArea_CH1_Vrms.setXY(22, 175);
    textArea_CH1_Vrms.setColor(touchgfx::Color::getColorFromRGB(212, 199, 25));
    textArea_CH1_Vrms.setLinespacing(0);
    Unicode::snprintf(textArea_CH1_VrmsBuffer, TEXTAREA_CH1_VRMS_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_KPU0).getText());
    textArea_CH1_Vrms.setWildcard(textArea_CH1_VrmsBuffer);
    textArea_CH1_Vrms.resizeToCurrentText();
    ...
    textArea_CH1_Amax.setXY(22, 76);
    textArea_CH1_Amax.setColor(touchgfx::Color::getColorFromRGB(212, 199, 25));
    textArea_CH1_Amax.setLinespacing(0);
    Unicode::snprintf(textArea_CH1_AmaxBuffer, TEXTAREA_CH1_AMAX_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_H7TK).getText());
    textArea_CH1_Amax.setWildcard(textArea_CH1_AmaxBuffer);
    textArea_CH1_Amax.resizeToCurrentText();
    textArea_CH1_Amax.setTypedText(touchgfx::TypedText(T___SINGLEUSE_UYVU));
    add(textArea_CH1_Amax);

    textArea_CH1_UnitsAmpRMS.setXY(125, 46);
    textArea_CH1_UnitsAmpRMS.setColor(touchgfx::Color::getColorFromRGB(212, 199, 25));
    textArea_CH1_UnitsAmpRMS.setLinespacing(0);
    textArea_CH1_UnitsAmpRMS.setTypedText(touchgfx::TypedText(T___SINGLEUSE_B4B8));
    add(textArea_CH1_UnitsAmpRMS);
